...
Nitidoc uses spec-driven development for substantial features. Planning
artifacts live under `openspec/changes/<change-name>/` (proposal, spec, design,
tasks). See the [README](README.md) for setup, scripts, and the OpenCV-in-dev
caveat.
