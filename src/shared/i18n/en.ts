...
export const en = {
  ...
  'paper.detected': 'Detected: {format} ({confidence})',
  'paper.manual': 'Manual: {format}',
  'paper.clearToAuto': 'Use detected format',
  'paper.confidenceHigh': 'high confidence',
  'paper.confidenceMedium': 'medium confidence',
  ...
  'capture.paperFormat': 'Paper size',
  'capture.paperGuide': 'Framing guide for {format}',
  'capture.paperA4A3': 'A4 / A3',
  'capture.paperOficio': 'Oficio',
  'capture.paperLetter': 'Letter',
  'capture.paperLegal': 'Legal',
  'capture.paperTicket': 'Card / ID',
  'capture.paperOriginal': 'Free form',
